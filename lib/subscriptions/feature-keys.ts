export const FEATURE_KEYS = {
    ...
    AI_PROFILE_APPEARANCES_MONTHLY: 'ai_profile_appearances_monthly',
    ...
    CONTENT_POSTING_ACCESS: 'content_posting_access',
    ROADMAP_UPLOAD_ACCESS: 'roadmap_upload_access',
    ROADMAP_DOWNLOAD_ACCESS: 'roadmap_download_access',
    KNOWLEDGE_HUB_ACCESS_LEVEL: 'knowledge_hub_access_level',
    INDUSTRY_EXPERT_LISTING_LIMIT: 'industry_expert_listing_limit',
    INDUSTRY_EXPERT_ACCESS_LEVEL: 'industry_expert_access_level',
