...
export function SessionRating({ sessionId, reviewee, onComplete }: SessionRatingProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-2xl w-full p-8 sm:p-12 bg-white dark:bg-gray-800 text-center rounded-2xl shadow-2xl max-h-[85vh] overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-6 mb-8 text-left max-h-[55vh] overflow-y-auto pr-1">
